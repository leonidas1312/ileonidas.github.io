...
import { URLs } from './user-data/urls.js';
  ...
  const { webProjects, softwareProjects, VRPTWpaper, freelanceProjects } =
    projects;
  ...
  // added title of page
   window.parent.document.title = "Ioannis D. Leonidas";
  }
  ...
  //populateProjects(VRPTWpaper, "research-VRPTW");
